...
public class ColorFeatureExtractor {
  ...
  public static void main(String[] args) throws IOException {
	  ColorFeatureExtractor colorFeatureExtractor = new ColorFeatureExtractor();
    // Load the image
	  File file = new File("C:/Users/KIIT/eclipse-workspace1/crop/image/img.jpeg");
...
//    
    ...
    System.out.println("average red value: " +sumred);
    System.out.println("average green value: " +sumgreen);
    System.out.println("average blue value: " +sumblue);
    
    double redRatio = (double)sumred / 255.0;
    double greenRatio = (double)sumgreen / 255.0;
    double blueRatio = (double)sumblue / 255.0;
    
   
    double ph = 1.0 * Math.log10((redRatio + greenRatio * 10.0 + blueRatio * 100.0) / 111.111);
    System.out.println("The estimated pH value of the image is: " + ph);

    System.out.println(colorFeatureExtractor.getColorNameFromRgb(maxRed,maxGreen ,maxBlue));
  }
